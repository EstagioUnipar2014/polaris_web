...
class CoberturasControllerTest < ActionController::TestCase
  ...
  test "should create cobertura" do
    assert_difference('Cobertura.count') do
      post :create, cobertura: { animal_id: @cobertura.animal_id, cio_id: @cobertura.cio_id, data: @cobertura.data }
    end
  ...
  test "should update cobertura" do
    patch :update, id: @cobertura, cobertura: { animal_id: @cobertura.animal_id, cio_id: @cobertura.cio_id, data: @cobertura.data }
    assert_redirected_to cobertura_path(assigns(:cobertura))
  end
